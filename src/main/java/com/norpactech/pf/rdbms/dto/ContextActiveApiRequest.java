 ...
 */
public class ContextActiveApiRequest {

  private UUID id;
  private Timestamp updatedAt;
  private String updatedBy;

  public ContextActiveApiRequest () {}

  @Hidden
  public Map<String, Object> getDeactRequest() {
    
    var request = new LinkedHashMap<String, Object>();
    request.put("sql", "SELECT pareto.deact_context(?,?,?)");
  ...
  public Map<String, Object> getReactRequest() {
    ...
    var request = new LinkedHashMap<String, Object>();
    request.put("sql", "SELECT pareto.react_context(?,?,?)");
    request.put("id", this.id);
    request.put("updatedAt", this.updatedAt);
    request.put("updatedBy", this.updatedBy);
    return request;
